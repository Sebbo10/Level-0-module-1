...
color=simpledialog.askstring(title= "Tomato", prompt="What tomato color do you like(red, purple, yellow)")
if color == "red":
...
if color == "yellow":
    ...
    messagebox.showinfo(title="Error", message= "Put an actual answer")
root.mainloop()
